...
//
// class SearchAllResult extends StatefulWidget {
//   final String query; // Pass the search query to the screen
//
//   const SearchAllResult({super.key, required this.query});
//
//   @override
...
//   Future<void> fetchSearchResults() async {
//     final response = await http.get(Uri.parse(
//         'https://ticketresellapi-ckhsduaycsfccjek.eastasia-01.azurewebsites.net/api/Post/get-lists?status=ACTIVE&searchTerm=${widget.query}&status=ACTIVE&page=1&limit=100'));
//
//     print('Response status: ${response.statusCode}');
//     print('Response body: ${response.body}');
//
...
//       appBar: AppBar(
//         backgroundColor: Colors.white,
//         title: Text('Search Results', style: Theme.of(context).textTheme.headlineMedium),
//         centerTitle: true,
//       ),
...
//               TGridLayout(
//                 itemCount: searchResults.length,
//                 itemBuilder: (_, index) => PostCardVertical(postResponse: searchResults[index]),
//               ),
//             ],
//           ),
//         ),
